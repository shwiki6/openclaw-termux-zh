...
class BootstrapService {
  ...
  Future<void> runFullSetup({
    ...
    try {
      ...
      // Step 4: Install OpenClaw (80-98%). This is optional; the base
      // terminal environment is considered usable after Node.js is ready.
      if (!installOptions.installOpenClaw) {
        _emitProgress(
          onProgress: onProgress,
          step: SetupStep.installingOpenClaw,
          progress: 1.0,
          message: 'OpenClaw installation skipped',
          detail: 'The Ubuntu, base packages, bionic bypass, and Node.js environment are ready.',
        );
      } else {
