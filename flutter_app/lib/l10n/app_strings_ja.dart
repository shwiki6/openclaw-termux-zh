const Map<String, String> appStringsJa = {
  ...
  'providerDetailModelHintZhipu': '例: glm-5、glm-4.7、glm-4.6',
  'providerDetailFetchModels': 'モデルを取得',
  'providerDetailFetchingModels': '取得中...',
  'providerDetailFetchModelsFailed': 'モデルの取得に失敗しました: {error}',
  'providerDetailFetchModelsEmpty': '利用可能なモデルが返されませんでした',
  'providerDetailFetchModelsSuccess': '{count} 件のモデルを取得しました',
  ...
  'customProviderFetchModelsAction': 'モデルを取得',
  ...
  'initialSetupChoiceTitle': '実行環境をインストール',
  'initialSetupChoiceBody':
      '初回起動では Ubuntu ターミナル、基本パッケージ、Bionic Bypass、Node.js のインストールが必要です。OpenClaw は今すぐ、または後で設定からインストールできます。',
  'initialSetupChoiceInstall': '基本環境と OpenClaw をインストール',
  'initialSetupChoiceSkip': '基本環境のみインストール',
  'initialSetupChoiceSkipHint': 'OpenClaw は任意で、後で設定からインストールできます。',
  ...
  'setupWizardBeginBaseOnly': '基本環境をインストール',
  'setupWizardEnterApp': 'アプリへ進む',
  'setupWizardOpenClawDeferredHint':
      'OpenClaw はスキップされました。ゲートウェイが必要になったら設定からインストールできます。',
  'setupWizardInstallOpenClawToggleTitle': 'OpenClaw をインストール',
  'setupWizardInstallOpenClawToggleOn':
      '基本 Linux 環境の準備後に OpenClaw もインストールします。',
  'setupWizardInstallOpenClawToggleOff':
      'Ubuntu、基本パッケージ、Bionic Bypass、Node.js のみインストールします。',
  ...
  'setupWizardStepSkipOpenClaw': 'OpenClaw をスキップ',
  ...
  'setupWizardStatusOpenClawSkipped': 'OpenClaw のインストールをスキップしました',
  ...
  'setupWizardStatusBaseReady':
      '基本環境の準備が完了しました。OpenClaw は後でインストールできます。',
  ...
  'settingsThirdPartyNotices': 'オープンソース通知',
  'settingsOpenSourceSources': 'オープンソースのソース情報',
