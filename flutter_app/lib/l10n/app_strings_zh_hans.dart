const Map<String, String> appStringsZhHans = {
  ...
  'providerDetailFetchModels': '获取模型',
  'providerDetailFetchingModels': '获取中...',
  'providerDetailFetchModelsFailed': '获取模型失败：{error}',
  'providerDetailFetchModelsEmpty': '没有获取到可用模型',
  'providerDetailFetchModelsSuccess': '已获取 {count} 个模型',
  ...
  'customProviderFetchModelsAction': '获取模型',
  'customProviderFetchingModelsAction': '获取中...',
  ...
  'openClawReleaseListLimitHint': '仅显示最新 10 个稳定版本，展开版本可查看更新内容。',
  'openClawReleaseListEmpty': '暂无可用版本',
  'openClawReleaseNotesTitle': '更新内容',
  'openClawReleaseNotesLoading': '正在加载该版本更新内容...',
  'openClawReleaseNotesUnavailable': '该版本未在 npm registry 提供更新说明。',
  'openClawReleaseSummary': '{size} · 发布于 {date}',
  'openClawReleasePackageSize': '解压后大小：{size}',
  'openClawReleasePublishedAt': '发布时间：{date}',
  ...
  'initialSetupChoiceTitle': '安装运行环境',
  'initialSetupChoiceBody':
      '首次启动必须先安装 Ubuntu 终端、基础软件包、Bionic Bypass 和 Node.js。OpenClaw 可以现在安装，也可以稍后在设置中安装。',
  'initialSetupChoiceInstall': '安装基础环境和 OpenClaw',
  'initialSetupChoiceSkip': '只安装基础环境',
  'initialSetupChoiceSkipHint': 'OpenClaw 是可选组件，以后可在设置中安装。',
  ...
  'setupWizardBeginBaseOnly': '安装基础环境',
  'setupWizardEnterApp': '进入首页',
  'setupWizardOpenClawDeferredHint': '已跳过 OpenClaw。需要网关时可在设置中继续安装。',
  'setupWizardInstallOpenClawToggleTitle': '安装 OpenClaw',
  'setupWizardInstallOpenClawToggleOn': '基础 Linux 环境完成后继续安装 OpenClaw。',
  'setupWizardInstallOpenClawToggleOff': '仅安装 Ubuntu、基础软件包、Bionic Bypass 和 Node.js。',
  ...
  'setupWizardStepSkipOpenClaw': '跳过 OpenClaw',
  ...
  'setupWizardStatusOpenClawSkipped': '已跳过 OpenClaw 安装',
  'setupWizardStatusBypassConfigured': 'Bionic Bypass 已配置',
  'setupWizardStatusReady': '安装完成，可以开始启动网关了。',
  'setupWizardStatusBaseReady': '基础环境已就绪，OpenClaw 可稍后安装。',
  ...
  'settingsLicense': '许可证',
  'settingsThirdPartyNotices': '开源许可说明',
  'settingsOpenSourceSources': '开源组件源码说明',
